...
// Upload DIRETO para Cloudinary — sem passar pelo servidor, sem assinatura

const CLOUD  = "dd2tfdq40";
const PRESET = (import.meta as any).env?.VITE_CLOUDINARY_UPLOAD_PRESET || "thome_unsigned";
